...
const openPopupboxAlfresko= () => {
    const content = (
        ...
        <b className = "link-desc"></b> <a className = "hyper-link" onClick = {() => window.open("https://github.com/maifam/al_fresko_backend")} >https://github.com/maifam/al_fresko_backend</a><br></br>
